            ...
            fn (): string => Blade::render('
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", async () => {
                        // Prefetch chantier data into IndexedDB for offline access
                        ...
                        window.addEventListener("online", async () => {
                            if (wasOffline) {
                                ...
                                // Trigger sync on all offline pages
                        ...
                        function showToast(message) {
                            ...
                            toast.className = "fixed bottom-4 right-4 z-[9999] px-4 py-3 bg-emerald-600 text-white rounded-lg shadow-lg flex items-center gap-2 transition-opacity";
