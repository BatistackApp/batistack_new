...
return new class extends Migration
{
    ...
    {
        Schema::create('laser_delivery_note_lines', function (Blueprint $table) {
            $table->id();
            $table->foreignId('laser_delivery_note_id')->constrained()->cascadeOnDelete();
            ...
            $table->decimal('cut_length_mm', 10, 2);
    ...
    {
        Schema::dropIfExists('laser_delivery_note_lines');
    }
};
