...
class PayrollContributionProfileSeeder extends Seeder
{
    ...
    private function seedCadreProfile(): void
    {
        $profile = PayrollContributionProfile::updateOrCreate(
            ['code' => 'BTP_CADRE'],
            [
                'name' => 'Bâtiment (Cadres)',
                'description' => 'Profil de cotisations pour les employés Cadres du Bâtiment',
                'meal_allowance_amount' => 11.20,
            ]
        );
        ...
        $rates = [
            ...
            [
                'category' => 'Santé',
                'label' => 'Complémentaire - Incap. Inval. Décès (Prévoyance Cadre)',
                'employee_rate' => 0.0000,
                'employer_rate' => 1.5000, // Souvent 1.50% TA à la charge exclusive de l'employeur pour les cadres
                'base_formula' => ContributionBaseFormula::GROSS_SALARY,
                'is_deductible' => true,
                'is_fiscally_reintegrated' => true,
            ],
            ...
            [
                ...
                'label' => 'Accidents du travail & mal. professionnelles',
                'employee_rate' => 0.0000,
                'employer_rate' => 7.3900, // Peut varier selon le code risque, on garde le standard
                'base_formula' => ContributionBaseFormula::GROSS_SALARY,
                'is_deductible' => true,
            ],
            ...
            [
                'category' => 'Retraite',
                'label' => 'Complémentaire Tranche 1 (AGIRC-ARRCO)',
                'employee_rate' => 4.2600,
                'employer_rate' => 5.7600,
                'base_formula' => ContributionBaseFormula::GROSS_SALARY,
                'is_deductible' => true,
            ...
            [
                'category' => 'Retraite',
                'label' => 'APEC',
                'employee_rate' => 0.0240,
                'employer_rate' => 0.0360,
                'base_formula' => ContributionBaseFormula::GROSS_SALARY, // Normalement limité à 4 PSS, mais on simplifie au brut
                'is_deductible' => true,
            ],
