...
<head>
    ...
    <!-- Tailwind CSS (via CDN for simplicity on error pages, but you can use Vite if available) -->
                ...
                extend: {
                    ...
                    colors: {
                        batistack: {
                            ...
                            500: '#334e68',
                            600: '#243b53',
                            700: '#102a43', // Primary dark blue
                            800: '#0a192f',
                            900: '#060f1c',
                        },
                        accent: {
                            500: '#f59e0b', // Amber/Orange accent for construction feel
                        }
                    }
                }
            }
