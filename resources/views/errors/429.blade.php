...
<head>
    ...
    <title>Trop de Requêtes - Batistack</title>
    ...
    <div class="max-w-2xl w-full px-6 py-12 bg-white rounded-2xl shadow-xl border border-batistack-100 text-center relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <p class="text-lg text-batistack-500 mb-8 max-w-lg mx-auto leading-relaxed">
                Le serveur reçoit trop de requêtes de votre part. Veuillez patienter quelques instants avant de réessayer.
            </p>
            <div class="mt-8">
            ...
            <div class="mt-10 text-sm text-batistack-500">
                <p class="mt-2 text-xs font-mono text-batistack-400">Code HTTP : 429 - Too Many Requests</p>
            </div>
        </div>
    </div>
