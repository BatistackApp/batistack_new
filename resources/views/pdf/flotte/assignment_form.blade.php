...
@section('content')
    ...
    <div class="grid grid-cols-2 gap-8 mb-8">
        ...
        <section class="bg-blue-50 p-5 rounded-2xl border border-blue-100">
            ...
            <div class="text-[10px] space-y-2">
                ...
                <p><strong>Catégorie :</strong> {{ $assignment->vehicle->type->getLabel() }}</p>
            </div>
        </section>
    </div>
    ...
    <div class="mb-8">
        ...
        <table class="text-[10px] w-full border border-slate-200">
            ...
            <tr class="h-10 bg-slate-50">
                ...
                <td class="font-bold px-3 border-l">Kilométrage au Départ :</td>
                <td class="text-right px-3 font-mono font-bold">{{ number_format($assignment->start_odometer, 1, ',', ' ') }} km</td>
            </tr>
            <tr class="h-10">
    ...
    <div class="p-6 border border-slate-300 rounded-xl bg-slate-50 text-[9px] text-justify leading-relaxed mb-10">
        ...
        <p class="mb-2">Le salarié soussigné reconnaît avoir reçu les clés et les documents de bord du véhicule désigné ci-dessus en parfait état de marche, de propreté et de sécurité. Le présent document formalise le transfert de la garde juridique du véhicule conformément aux articles 1242 et suivants du Code civil.</p>
    ...
    <footer class="fixed bottom-0 left-0 w-full p-8 text-[8px] text-slate-400 border-t border-slate-100 flex justify-between">
        ...
        <div class="font-bold uppercase tracking-wider">Flotte Assignment Form v1.0</div>
    </footer>
@endsection
