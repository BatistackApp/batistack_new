<div class="flex flex-col bg-white p-5 rounded-lg shadow-lg">
    <div class="flex flex-row justify-between bg-blue-500 p-2 rounded-t-2xl text-white">
        <span>TOTAL HT</span>
    ...
    <div class="flex flex-row justify-between bg-blue-500 p-2 text-white rounded-b-2xl font-bold text-xl">
        <span>TOTAL TTC</span>
