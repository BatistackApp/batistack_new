...
### 2. Logique Métier & Services (`app/Services/Articles`)
...
*   **Génération de Bons de Réapprovisionnement Automatisée** : Créer un process ou Job nocturne qui analyse les seuils d'alerte de "stock minimum" et prépare automatiquement des brouillons de Commandes d'Achat ciblées par fournisseur.
