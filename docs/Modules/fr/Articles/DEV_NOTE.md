...
*   **Traçabilité des lots et dates de péremption** : Le `StockService` et les mouvements de stock gèrent maintenant les numéros de lots et les dates de péremption pour les articles sensibles. Un job nocturne (`CheckExpiringStocksJob`) alerte les administrateurs des lots approchant de leur date de péremption.
