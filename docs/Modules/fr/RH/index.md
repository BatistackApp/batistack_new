...
Bienvenue dans la documentation du module **RH** de Batistack.
...
- [L'Espace Salarié](./06-espace-salarie.md) : Le portail self-service du collaborateur — contrat, congés et soldes, pointages, notes de frais, équipements, déclaration de casse et documents personnels.

> [!TIP]
> **Le Lien avec la Paie**
> Toutes les données saisies dans le module RH (temps de travail, jours d'absence, primes, acomptes, montants des saisies SATD) sont automatiquement transmises au Moteur de Paie pour éditer les bulletins en fin de mois.
